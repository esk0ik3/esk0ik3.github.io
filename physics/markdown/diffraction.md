...
<a href="https://esk0ik3.github.io/physics/markdown/jones_matrix.html" style="text-decoration: none; color: inherit;">
  <div class="card" style="border: 1px solid #e2e8f0; border-left: 5px solid #3373eb; border-radius: 8px; padding: 20px; margin: 16px 0; background: linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%); color: #0f172a; cursor: pointer; transition: all 0.3s ease; box-shadow: 0 4px 12px rgba(51, 115, 235, 0.08);" 
  onmouseover="this.style.boxShadow='0 12px 28px rgba(51, 115, 235, 0.3)'; this.style.transform='translateY(-4px)';" 
  onmouseout="this.style.boxShadow='0 4px 12px rgba(51, 115, 235, 0.08)'; this.style.transform='translateY(0)';">
    <h3 style="margin-top: 0; color: #1e293b; margin-bottom: 8px;">ジョーンズ行列</h3>
    <p style="color: #475569; margin: 0;">光の偏光を行列で表現する理論について学びます。</p>
  </div>
</a>
